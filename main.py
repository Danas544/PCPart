...
class CPU(PCPart):
    def __init__(self, name: str, price: float, brand: str, speed: str, power_usage: str, color: Optional[str] = None):
...
class GPU(PCPart):
    def __init__(self, name: str, price: float, brand: str, memory: str, color: Optional[str] = None):
        super().__init__(name, price, color)
        self.brand = brand
        self.memory = memory
...
if __name__ == "__main__":
    ...
    print(f"CPU: {cpu.get_name()}, Brand: {cpu.get_brand()}, NEW Price: {cpu.get_price()}")